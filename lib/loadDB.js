...
const connectURL = process.env.DATABASE_URL || `${process.env.USER}:@localhost:5432/${process.env.USER}`
const params = url.parse(connectURL);
const auth =  params.auth.split(':') : `${process.env.USER}:`
